...
- Cree un proyecto de React con create-vite: `npm init --yes vite@latest agrosystemclient -- --template=react-ts  --no-rolldown --no-immediate`.
- Actualizando `vite.config.ts` con puerto.
- Crear archivo de proyecto (`agrosystemclient.esproj`).
